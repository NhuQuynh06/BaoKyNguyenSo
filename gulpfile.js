...
gulp.task('style', async function() {
    ...
    gulp.src(paths.scss_dev + file_style + ".scss", { allowEmpty: true })
...
function watchFiles() {
    ...
    gulp.watch(paths.scss_dev, gulp.series('style', 'browsersync'));
...
/*
gulp new-cms --path d-kynguyenso
gulp new-cms --path m-kynguyenso
*/